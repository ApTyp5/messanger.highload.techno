...
из реплик, на которой предварительно были сжаты и выгружены все прочитанные сообщения (в случае MVP удалены, алгоритм описан далее).
...
4. Начать отчистку
5. По окончании отчистки войти в кластер в качестве slave
