...
Так как DNS многократно кэшируется, то высоконагруженной её нельзя назвать. В нашем
...
### Рассчет требуемого оборудования для master, slave и application сервреров:
...
|Balancers L7| 3 для отказоустойчивости | 3 |
|Balancres L4| 3 для отказоустойчивости | 3 |
